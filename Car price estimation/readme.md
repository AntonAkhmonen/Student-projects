По условиям задачи необходимо выбрать оптимальную модель экспресс-расчета стоимости подержанных автомобилей. Целевой показатель - значение метрики RMSE < 2500. 
